...
const jersey = AG.generateAvatar(1388, { teamColors: colors });
const suit = AG.generateAvatar(1388, { teamColors: colors, outfit: "suit", suitColors: colors });
...
if (AG.generateAvatar(1388, { teamColors: colors }).includes('fill="#e9eef5"')) throw new Error("❌ Les joueurs ne doivent pas être en costume.");

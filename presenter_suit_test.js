...
const jersey = AG.generateAvatar(7413, { teamColors: colors });
const suit = AG.generateAvatar(7413, { teamColors: colors, outfit: "suit", suitColors: colors });
...
if (AG.generateAvatar(7413, { teamColors: colors }).includes('fill="#e9eef5"')) throw new Error("❌ Les joueurs ne doivent pas être en costume.");

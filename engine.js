...
class MatchEngine {
  ...
  playPossession(offTeam, defTeam, quarter, clock, events, scoreDiff) {
    ...
    // division. ça reste un jeu") : au-dessus de 60 la pente reste 0.0048
    // par point, en dessous elle est divisée par trois (0.0016). Mesuré avec
    ...
    // (tier 0.85-1.15) 83 → 86 pts ; Division I inchangée (98 pts).
    const attrDelta = effStat >= 60 ? (effStat - 60) * 0.0048 : (effStat - 60) * 0.0016;
